...
class AccountLoan(models.Model):
    ...
    move_ids = fields.One2many("account.move", copy=False, inverse_name="loan_oca_id")
    ...
    def _compute_draft_lines(self):
        ...
        for i in range(1, self.periods + 1):
            line = self.env["account.loan.line.oca"].create(
    ...
    def view_account_moves(self):
        ...
        result["domain"] = [("loan_oca_id", "=", self.id)]
        return result
    ...
    def view_account_invoices(self):
        ...
        result["domain"] = [("loan_oca_id", "=", self.id), ("move_type", "=", "in_invoice")]
        return result
