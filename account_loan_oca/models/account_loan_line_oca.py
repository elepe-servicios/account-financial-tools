...
class AccountLoanLine(models.Model):
    ...
    def _move_vals(self, journal=False, account=False):
        return {
            "loan_line_oca_id": self.id,
            "loan_oca_id": self.loan_id.id,
            "date": self.date,
            "ref": self.name,
    ...
    def view_account_moves(self):
        ...
        result["context"] = {
            "default_loan_line_oca_id": self.id,
            "default_loan_oca_id": self.loan_id.id,
        }
        result["domain"] = [("loan_line_oca_id", "=", self.id)]
